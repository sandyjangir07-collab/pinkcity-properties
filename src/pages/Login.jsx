...
export default function Login() {
  ...
  // Plain, standard Supabase OAuth redirect — no popup, no pre-fetching, no
  // custom handoff logic. Four increasingly elaborate attempts to also keep
  // an installed PWA looking "standalone" through this flow all made actual
  // sign-in less reliable, not more. Reliably signing in matters more than
  // that cosmetic detail, so this is deliberately the simplest possible
  // implementation.
    ...
    <div className="relative min-h-screen flex items-center justify-center p-5 overflow-hidden bg-sand">
      ...
      >
        ...
        <button
          ...
          disabled={googleBusy}
          className="w-full flex items-center justify-center gap-2.5 text-sm font-medium text-ink/75 border border-ink/10 rounded-full py-3 mb-5 hover:border-ink/25 transition-colors disabled:opacity-50"
        >
