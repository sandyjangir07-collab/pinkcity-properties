    ...
    <div className="relative min-h-screen flex items-center justify-center p-5 overflow-hidden bg-sand">
      ...
      >
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2.5 text-sm font-medium text-ink/75 border border-ink/10 rounded-full py-3 mb-5 hover:border-ink/25 transition-colors"
        >
