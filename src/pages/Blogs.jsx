              ...
              >
                ...
                <div className="p-4">
                  ...
                  <div className="flex gap-1.5 flex-wrap">
                    <a href={`https://pinkcityproperties.com/blog/${p.slug}`} target="_blank" rel="noreferrer" className="text-xs font-medium text-ink/60 border border-ink/10 rounded-full px-3 py-1.5 no-underline">
                      Preview
                    </a>
